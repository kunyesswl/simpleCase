 ...
 */
package com.scase.core.service.impl;
...
import com.scase.core.dao.BaseDao;
import com.scase.core.entity.BaseEntity;
import com.scase.core.model.Filter;
import com.scase.core.model.Order;
import com.scase.core.model.Page;
import com.scase.core.model.Pageable;
import com.scase.core.service.BaseService;
...
public class BaseServiceImpl<T, ID extends Serializable> implements BaseService<T, ID> {
	...
	public T get(String propety, Object value) {
		Filter filter = new Filter(propety,Filter.Operator.eq,value	);
		List<Filter> filters = new ArrayList<Filter>();
		filters.add(filter);
		List<T> lst = this .findList(1,filters, null);
