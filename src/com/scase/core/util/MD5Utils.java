 ...
 */
package com.scase.core.util;
/**
 * 
  * @author  (mail) 2014-3-13
  * @version 1.0
  * @Function 类功能说明
 */
...
//		return (long) (byte0 < 0 ? byte0 & 0xff : byte0);
	...
	/**
	 * 
	  * byteHEX(这里用一句话描述这个方法的作用)
	  * @param byte0
	  * @return
	 */
	public static String byteHEX(byte byte0) {
		char[] ac = { 'Z', '4', 'X', 'A', '1', '6', '3', 'Y', '5', '2', 'C',
				'8', '9', '0', 'B', '7' };
		char[] ac1 = new char[2];
	...
	/**
	 * @todo Tests a String to MD5.
	 * @param args
	 *            String[]
	 */
	public static void main(String[] args){
		MD5Utils md5 = getInstance();
//		System.out.println("MD5(\"123456\"):" + md5.getMD5("123456"));
//		System.out.println("MD5(\"abcefg\"):" + md5.getMD5("abcefg"));
//		
		System.out.println(md5.getMD5("linjzticketHotel"));
	}
